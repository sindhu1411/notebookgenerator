...
const notebookCells = [
  {
    ...
    explanation:
      "Start by reading the sheet and checking the incoming headers, null patterns, and label column.",
  },
  {
    ...
    <main className="page-shell">
      <section className="hero panel tutorial-hero">
        ...
        <div className="tutorial-summary">
          ...
          <span className="chip">Fraud labels: {Math.round(dataset.fraudRate * 100)}%</span>
          <span className="chip">Resolved blanks: {dataset.missingBefore - dataset.missingAfter}</span>
        </div>
      </section>
      ...
      <section className="panel insight-grid">
        <article className="insight-card">
          ...
          <p>
            In this fake job sheet, the highest fraud rates appear in postings with missing company
            logos, vague departments, and low-information salary fields.
          </p>
        </article>
        <article className="insight-card">
          ...
          <p>
            The project uses Next.js static export so it can be deployed to Vercel or GitHub Pages
            without a backend.
          </p>
        </article>
      </section>
